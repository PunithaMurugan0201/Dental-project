  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // ✅ Fetch patient data from /api/mdspatient/:id
        const patientRes = await axios.get(`http://localhost:5000/api/mdspatient/${patientId}`, {
          headers: {
            Authorization: `Bearer ${token}`
          }
        });

        // ✅ Fetch followups from /api/followups/:id
